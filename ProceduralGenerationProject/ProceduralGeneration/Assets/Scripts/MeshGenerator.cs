...
{
    public static Mesh Generate(int _density, float[,] _noiseMap, float _spacing, AnimationCurve _heightCurve ,float _heightScaler = 10f)
    {
        Mesh mesh = new()
        {
